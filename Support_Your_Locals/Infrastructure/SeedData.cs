        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Business.Any())
            {
                context.Business.AddRange(
                    ...
                    {
                        UserID = 10,
                        Product = "Nusirašinėjimas",
                        Description = "Rašau referatus, rašinius ir t.t.",
                        Header = "Nenorit daryt mokyklinio projekto?" +
                        "Susisiekit, padarysiu už jus!",
                        PhoneNumber = "+37064752660"
                    },
                    new Business
                    {
                        UserID = 7,
                        Product = "Piešiniai",
                        Description = "Galiu daryti portretus, natiurmortą, peisažą ir t.t.",
                        Header = "Piešiniai už (beveik) dyką!",
                    ...
                    {
                        UserID = 4,
                        Product = "Labdara seneliams",
                        Description = "Paaukokite senelių namuose gyvenantiems senjorams",
                        Header = "Padarykite gerą darbą " +
                        "vieno mygtuko paspaudimu!",
                        PhoneNumber = "+37062199630"
                    }
