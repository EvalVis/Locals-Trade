...
namespace Support_Your_Locals.Infrastructure
{
    public class SeedData
    {
        ...
        public static void EnsurePopulated(IApplicationBuilder app, HashCalculator hashCalculator, Imager imager)
        {
            ...
            {
                context.Users.AddRange(CreateTestMaterial(context, hashCalculator, imager));
                context.SaveChanges();
            }
        }
        ...
        private static Business CreateBusiness(string product, string description, string longitude, string latitude, string phone, string header, byte[] image)
        {
            return new Business
            {
        ...
        private static User[] CreateTestMaterial(ServiceDbContext context, HashCalculator hashCalculator, Imager imager)
        {
            ...
            Business b1 = CreateBusiness("Traktoriai", "Traktorių parduotuvė", "25.274633", "54.699603", "+37064575620", "10% nuolaida žieminėms padangoms", imager.ByteMaker("diagram.png"));
            Business b2 = CreateBusiness("Automobiliai", "Daužti automobiliai už prieinamą kainą", "25.268811", "54.693882", "+37064215675", "Įsigykite automobilius be rėmo, greit neliks", null);
            Business b3 = CreateBusiness("Saldainiai", "Įvairūs", "25.269173", "54.688853", "+37064215201", "Saldainių parduotuvė", null);
            Business b4 = CreateBusiness("Išdaigos", "Smagūs niekučiai", "25.281194", "54.681308", "+37064512012", "Išpardavimas išdaigininkams", null);
            Business b5 = CreateBusiness("Automobilių remontas", "Nuo 7:00 iki 8:00 ryto remontuoju už dyką", "25.214340", "54.379052", "+37064512456", "Automobilių remontas", null);
            Business b6 = CreateBusiness("Nusirašinėjimas", "Rašau referatus, rašinius ir t.t.", "25.391008", "54.290225", "+37064752660", "Nenorit daryt mokyklinio projekto? Susisiekit, padarysiu už jus!", null);
            Business b7 = CreateBusiness("Piešiniai", "Galiu daryti portretus, natiurmortą, peisažą ir t.t.", "25.359637", "54.306365", "+37064233450", "Piešiniai už (beveik) dyką!", null);
            Business b8 = CreateBusiness("Dėvėtos kojinės", "Paprastai labai kvepia", "25.304485", "54.630629", "+37064512478", "Yra ir smirdančių", null);
            Business b9 = CreateBusiness("Labdara seneliams", "Paaukokite senelių namuose gyvenantiems senjorams", "24.489809", "55.565052", "+37062199630", "Padarykite gerą darbą vieno mygtuko paspaudimu!", null);
            ...
            Business b10 = CreateBusiness("Wild berries", "Selling some kind of wild berries", "25.235131", "54.758748", "+37062199630", "Wild berries", imager.ByteMaker("10.jpg"));
            ...
            Business b11 = CreateBusiness("Berries", "Selling berries from my garden", "25.266962", "54.792729", "+37062199630", "Berries", imager.ByteMaker("11.jpg"));
            ...
            Business b12 = CreateBusiness("Services", "I can weld, electrical work", "25.298652", "54.783504", "+37062199111", "Services", imager.ByteMaker("12.jpg"));
            ...
            Business b13 = CreateBusiness("Farming work", "I can plow", "25.298652", "54.783504", "+37062199111", "Farming work", imager.ByteMaker("13.jpg"));
            ...
            Business b14 = CreateBusiness("Sewing", "You can order clothes to sew", "25.277352", "54.737149", "+37062199222", "Sewing", imager.ByteMaker("14.jpg"));
            ...
            Business b15 = CreateBusiness("Knitting", "You can order knited clothes", "25.277352", "54.737149", "+37062199222", "Knitting", imager.ByteMaker("15.jpg"));
            ...
            Business b16 = CreateBusiness("Clothes", "Selling used clothes for symbolic price", "25.226498", "54.708795", "+37062199222", "Clothes", imager.ByteMaker("16.jpg"));
            ...
            Business b17 = CreateBusiness("Dairy", "Selling home made dairy products", "25.506973", "54.676054", "+37062199333", "Dairy", imager.ByteMaker("17.jpg"));
            ...
            Business b18 = CreateBusiness("Eggs", "Selling chicken eggs", "25.326122", "54.638121", "+37062199222", "Eggs", imager.ByteMaker("18.jpg"));
            ...
            Business b19 = CreateBusiness("Dairy", "Selling home made goat dairy products", "25.506973", "54.676054", "+37062199333", "Dairy", imager.ByteMaker("19.jpg"));
            ...
            Business b20 = CreateBusiness("Bread", "Selling home made bread from my own wheat", "25.301730", "54.636929", "+37062199333", "Bread", imager.ByteMaker("20.jpg"));
            ...
            Business b21 = CreateBusiness("Goat", "Selling 1 year old goat", "25.301730", "54.636929", "+37062199333", "Goat", imager.ByteMaker("21.jfif"));
            ...
            Business b22 = CreateBusiness("Cat", "Giving cat for symbolic price", "25.262359", "54.639473", "+37062199331", "Cat", null);
            ...
            Business b23 = CreateBusiness("Dog", "Selling 1 year German Shepherd", "25.205261", "54.665214", "+37062199332", "Dog", null);
            ...
            Business b24 = CreateBusiness("Lizard", "Selling 1.5 year old green lizard", "25.249167", "54.708795", "+37062199330", "Lizard", null);
            ...
            Business b25 = CreateBusiness("Guinea pig", "Selling newborn white guinea pigs", "25.301730", "54.636929", "+37062199334", "Guinea pig", null);
            ...
            Business b26 = CreateBusiness("Smartphone service", "Fixing your phones", "25.309975", "54.706812", "+37062199355", "Repair job", null);
            ...
            Business b27 = CreateBusiness("Watch service", "Fixing your watches", "25.309975", "54.706812", "+37062199355", "Repair job", null);
            ...
            Business b28 = CreateBusiness("Laptop service", "Fixing your laptops", "25.300356", "54.678635", "+37062199356", "Repair job", null);
            ...
            Business b29 = CreateBusiness("Smartphone glass service", "Fast applying screen protecting glass", "25.257756", "54.679627", "+37062199356", "Repair job", null);
            ...
            Business b30 = CreateBusiness("Tire installation", "Fast changing car tires", "25.253633", "54.711374", "+37062199374", "Repair job", null);
            ...
            Business b31 = CreateBusiness("Oil change", "Fast changing engine oil", "25.228210", "54.702249", "+37062199355", "Repair job", null);
            ...
            Business b32 = CreateBusiness("Quail eggs", "Fixing your phones", "25.309975", "54.706812", "+37062199358", "Eggs", null);
            ...
            Business b33 = CreateBusiness("Kvass", "Fresh bread kvass", "25.258030", "54.698995", "+37062199359", "Drink", null);
            ...
            Business b34 = CreateBusiness("Vine", "Home made vine from apples", "25.180800", "54.725810", "+37062199388", "Drink", null);
            ...
            Business b35 = CreateBusiness("Apple juice", "Amazing apple juice", "25.180800", "54.725810", "+37062199388", "Drink", null);
            ...
            Business b36 = CreateBusiness("Walnuts", "This season walnuts", "25.088591", "54.778514", "+37062199301", "Nuts", null);
            ...
            Business b37 = CreateBusiness("Math tutor", "Teaching math to pass exams", "25.249243", "54.692726", "+37062199222", "Tutor", null);
            ...
            Business b38 = CreateBusiness("Chemistry tutor", "Profesional help for good results on exam", "25.262642", "54.680421", "+37062199374", "Tutor", null);
            ...
            Business b39 = CreateBusiness("Biology tutor", "Try to pass exams and help to understand topics better", "25.276590", "54.750784", "+37062199365", "Tutor", null);
            ...
            Business b40 = CreateBusiness("English tutor", "Help to prepare for exams", "25.241432", "54.807413", "+37062199332", "Tutor", null);
